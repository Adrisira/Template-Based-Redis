package com.project.PlaneFinde;
...
import com.project.PlaneFinde.aircraft.Aircraft;

@SpringBootApplication
public class PlaneFindeApplication {
	...
	public static void main(String[] args) {
		SpringApplication.run(PlaneFindeApplication.class, args);
	}
